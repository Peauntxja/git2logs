...
echo "✓ 打包成功！"
bash scripts/post_pyinstaller_clean.sh "dist/MIZUKI-TOOLBOX/_internal"
python3 scripts/audit_bundle.py "dist/MIZUKI-TOOLBOX/_internal" || exit 1
...
if [ -d "$APP_BUNDLE" ]; then
    ...
    echo "应用目录位置: dist/MIZUKI-TOOLBOX"
fi
